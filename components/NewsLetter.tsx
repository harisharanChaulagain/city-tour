...
export default function NewsLetter() {
  return (
    <main className="px-4 md:px-8 py-10 ">
      <section className=" bg-gray-200 py-10 rounded-2xl mx-auto px-4 md:px-8 text-[#1D1D1B]">
        ...
        <div className="mt-6 max-w-2xl mx-auto">
          ...
          >
            <input
              ...
              className="text-gray-600 w-full p-3 rounded-md border outline-none bg-gray-300"
            />
